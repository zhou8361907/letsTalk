import { formatDuration, shouldUseJsonLog } from "./agent-log.js";
import type { LogStep } from "@lets-talk/infrastructure/logging";
import type { TraceRecorder } from "@lets-talk/infrastructure/tracing";
import type { TraceRecord, TraceStepRecord } from "@lets-talk/infrastructure/tracing";
